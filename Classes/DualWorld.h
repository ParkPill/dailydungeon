#ifndef __DUALWORLD_SCENE_H__
#define __DUALWORLD_SCENE_H__
...
class DualWorld : public cocos2d::Layer
{
protected:
    ...
    Vector<Missile*> chasingMissileArray;
    Vector<Missile*> droppableMissileArray;
...
//    Vector<Laser*> laserArray;
//    Laser* laser;
    Weapon* getWeaponByTag(int tag);
    void onResultOk();
    Node* rivalMatchLayer;
    void splitUp();
    void runRivalMatchAnimation();
    Droppable* sptRedFace;
    std::vector<cocos2d::Rect> stageTileRectArray;
    Sprite* blackSquare;
    cocos2d::Size size;
    Vector<Droppable*> coinArray;
    Vector<Droppable*> starArray;
//    Vector<Shield*> enemyShieldArray;
//    Vector<Shield*> heroShieldArray;
    ...
    float lastPlayerHealth = 100;
    float lastEnemyHealth = 100;
...
//    void removeLaser();
    ...
    void setDualMap();
    Sprite* getWeapon(int weaponType);
...
/*
 ...
 TileInfo* getTileAtPosition(cocos2d::Point position, cocos2d::experimental::TMXLayer *layer);
    ...
    bool checkForAndResolveCollisionsForMissile(Missile* p);
    ...
    void fire(float dt=0);
    TMXTiledMap* theMap;
    void fire(Weapon* weapon, float dt=0);
...
//    bool containsTouchLocation(Touch* touch);
    ...
    void warpOut();
    void fireBottleMoveDone(Ref* ref);
    void startBattle();
    //DrawNode* dnDamageBoxes;
    //DrawNode* dnCollisionBoxes;
    void saveCollectMission();
};

#endif // __DUALWORLD_SCENE_H__
