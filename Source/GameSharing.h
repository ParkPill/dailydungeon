...
public:
    ...
    static void addSkuItemForStore(std::string skuID);
    static void addNonConsumableSkuItemForStore(std::string skuID);
    ...
    static void showInterstitialForIOS();
    static void addSkuItemForIOS(std::string item);
    static void initForIOS();
    static void showUnityAdsIOS();
    ...
    static std::string getPriceCurrencyIOS(std::string str);
    ...
    static std::string getSignedData();
    static std::string getSignature();
    static std::string getPriceAmount(const char* sku);
    static std::string getPriceCurrency(const char* sku);
    ...
    static void logFB(const char* msgToLog);
    static void firebaseLog(const char* logID, const char* logName, const char* logDetail);
};
